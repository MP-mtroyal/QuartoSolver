...
def backpropagate_all(folder, deepest_depth, shallowest_depth):
    ...
    for d in range(deepest_depth, shallowest_depth, -1):
        ...
        print(f"Require simulation : {len(parent_hash_set) - len(direct_matched)}")
